    ...
    <div class="container">
        ...
        <div class="history-content text-center">
            ...
            <div class="section-title-03">
                ...
                <h2 class="title">Furbar Furniture Shop</h2>
            </div>
        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="image-gallery">
                    <img src="assets/images/images-gallery/image-1.jpg" alt="gallery">
                </div>
                <!-- Image Gallery End -->
            </div>
            <div class="col-lg-4">
                <!-- Image Gallery Start -->
                <div class="image-gallery">
                    <img src="assets/images/images-gallery/image-2.jpg" alt="gallery">
                </div>
                <!-- Image Gallery End -->
            </div>
            <div class="col-lg-6">
                <!-- Image Gallery Start -->
                <div class="image-gallery">
                    <img src="assets/images/images-gallery/image-3.jpg" alt="gallery">
                </div>
                <!-- Image Gallery End -->
            </div>
            <div class="col-lg-6">
                <!-- Image Gallery Start -->
                <div class="image-gallery">
                    <img src="assets/images/images-gallery/image-4.jpg" alt="gallery">
                </div>
                <!-- Image Gallery End -->
            </div>
        </div>
            ...
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    ...
                    <div class="single-testimonial swiper-slide">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore dolorelo magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit</p>
                        <img class="author-thumb" src="assets/images/author-1.jpg" alt="Author">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="single-team">
                        ...
                        <div class="team-content">
                            <h5 class="name">Makiyah Yeager</h5>
                            <span class="designation">Customer</span>
                        </div>
                    </div>
                    <!-- Single Team End -->
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="single-team">
                        ...
                        <div class="team-content">
                            <h5 class="name">Taelynn Thorpe</h5>
                            <span class="designation">Customer</span>
                        </div>
                    </div>
                    <!-- Single Team End -->
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="single-team">
                        ...
                        <div class="team-content">
                            <h5 class="name">Sara Koivisto</h5>
                            <span class="designation">Customer</span>
                        </div>
                    </div>
                    <!-- Single Team End -->
